...
class $FoldersTable extends Folders with TableInfo<$FoldersTable, FolderRow> {
  ...
  @override
  List<GeneratedColumn> get $columns => [id, name, parentFolderId, sortOrder];
  @override
...
class NoteTagRow extends DataClass implements Insertable<NoteTagRow> {
  final String noteId;
  final String tag;
  const NoteTagRow({required this.noteId, required this.tag});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
  ...
  NoteTagRow copyWith({String? noteId, String? tag}) =>
      NoteTagRow(noteId: noteId ?? this.noteId, tag: tag ?? this.tag);
